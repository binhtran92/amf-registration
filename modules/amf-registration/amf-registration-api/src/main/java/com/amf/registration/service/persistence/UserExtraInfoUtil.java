...
/**
 * The persistence utility for the user extra info service. This utility wraps <code>com.amf.registration.service.persistence.impl.UserExtraInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see UserExtraInfoPersistence
 * @generated
 */
public class UserExtraInfoUtil {
	 ...
	 */
	public static void clearCache(UserExtraInfo userExtraInfo) {
		getPersistence().clearCache(userExtraInfo);
	}
	 ...
	 */
	public static Map<Serializable, UserExtraInfo> fetchByPrimaryKeys(
	 ...
	 */
	public static List<UserExtraInfo> findWithDynamicQuery(
	 ...
	 */
	public static UserExtraInfo update(UserExtraInfo userExtraInfo) {
		return getPersistence().update(userExtraInfo);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static UserExtraInfo update(
		UserExtraInfo userExtraInfo, ServiceContext serviceContext) {

		return getPersistence().update(userExtraInfo, serviceContext);
	}
	 ...
	 */
	public static List<UserExtraInfo> findByUuid(String uuid) {
	 ...
	 */
	public static List<UserExtraInfo> findByUuid(
	 ...
	 */
	public static UserExtraInfo findByUuid_First(
			String uuid, OrderByComparator<UserExtraInfo> orderByComparator)
		throws com.amf.registration.exception.NoSuchUserExtraInfoException {
	 ...
	 */
	public static UserExtraInfo fetchByUuid_First(
		String uuid, OrderByComparator<UserExtraInfo> orderByComparator) {
	 ...
	 * @throws NoSuchUserExtraInfoException if a matching user extra info could not be found
	 */
	public static UserExtraInfo findByUuid_Last(
			String uuid, OrderByComparator<UserExtraInfo> orderByComparator)
		throws com.amf.registration.exception.NoSuchUserExtraInfoException {
	 ...
	 */
	public static UserExtraInfo fetchByUuid_Last(
		String uuid, OrderByComparator<UserExtraInfo> orderByComparator) {
	 ...
	 */
	public static UserExtraInfo[] findByUuid_PrevAndNext(
			long extraInfoId, String uuid,
			OrderByComparator<UserExtraInfo> orderByComparator)
		throws com.amf.registration.exception.NoSuchUserExtraInfoException {

		return getPersistence().findByUuid_PrevAndNext(
			extraInfoId, uuid, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(UserExtraInfo userExtraInfo) {
		getPersistence().cacheResult(userExtraInfo);
	}
	 ...
	 */
	public static void cacheResult(List<UserExtraInfo> userExtraInfos) {
		getPersistence().cacheResult(userExtraInfos);
	}
	 ...
	 */
	public static UserExtraInfo create(long extraInfoId) {
		return getPersistence().create(extraInfoId);
	}
	 ...
	 * @throws NoSuchUserExtraInfoException if a user extra info with the primary key could not be found
	 */
	public static UserExtraInfo remove(long extraInfoId)
		throws com.amf.registration.exception.NoSuchUserExtraInfoException {

		return getPersistence().remove(extraInfoId);
	}

	public static UserExtraInfo updateImpl(UserExtraInfo userExtraInfo) {
		return getPersistence().updateImpl(userExtraInfo);
	}
	 ...
	 * @throws NoSuchUserExtraInfoException if a user extra info with the primary key could not be found
	 */
	public static UserExtraInfo findByPrimaryKey(long extraInfoId)
		throws com.amf.registration.exception.NoSuchUserExtraInfoException {

		return getPersistence().findByPrimaryKey(extraInfoId);
	}
	 ...
	 */
	public static UserExtraInfo fetchByPrimaryKey(long extraInfoId) {
		return getPersistence().fetchByPrimaryKey(extraInfoId);
	}
	 ...
	 */
	public static List<UserExtraInfo> findAll() {
	 ...
	 */
	public static List<UserExtraInfo> findAll(int start, int end) {
	...
	public static UserExtraInfoPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<UserExtraInfoPersistence, UserExtraInfoPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(UserExtraInfoPersistence.class);

		ServiceTracker<UserExtraInfoPersistence, UserExtraInfoPersistence>
			serviceTracker =
				new ServiceTracker
					<UserExtraInfoPersistence, UserExtraInfoPersistence>(
						bundle.getBundleContext(),
						UserExtraInfoPersistence.class, null);
